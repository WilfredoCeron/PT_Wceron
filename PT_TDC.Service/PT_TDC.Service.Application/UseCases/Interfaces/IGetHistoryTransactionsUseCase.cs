...
{
    public interface IGetHistoryTransactionsUseCase
    {
        Task<ObjectResponse<List<GetHistoryTransactionsResponse>>> GetHistoryTransactions(GetHistoryTransactionsQuery query);
    }
}
